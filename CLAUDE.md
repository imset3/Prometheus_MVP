# Prometheus project automation

For Unity scene operations, follow `Assets/_Project/Docs/AI_SCENE_TOOLKIT.md`.

- Use the project AI command contract instead of directly rewriting `.unity` YAML.
- Preview every mutation with `dryRun: true`.
